 ...
 * @dev Implements core FHE operations, access control, and security features using fhEVM v0.9.1
 */
abstract contract FHEDonationBase is Ownable, ReentrancyGuard, Pausable, ZamaEthereumConfig {
    ...
    function _toEuint16(euint32 value) internal returns (euint16) {
        ...
        // Note: In v0.9.1, use asEuint16 with proper bounds checking
