...
contract FHEMatchingPool is FHEDonationBase {
     ...
     * @param roundId Round ID
     * @param projectId Project ID
     * @param decryptedAmount The decrypted matching amount (provided off-chain via Relayer)
     * @dev In v0.9.1, use FHE.makePubliclyDecryptable() then query off-chain. Amount must be verified.
     */
